        ...
        <Container title='סל תקבולים' childrenStyle={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div className='paymentReportTablesContainer' style={{
                ...
                <div style={{ height: receptionBasketStore.rightTableReceptionBasket.length < 10 && 'fit-content', marginRight: 'calc(5em + 5px)' }}>
                    ...
                    <Table header={['שם', 'תאריך לשידור', 'יתרה כוללת', 'סמן להדפסה']}
                        ...
                        <div className='paymentReportTableTabsPosition' style={{ left: '100%' }}>
                            ...
                            <div className={`paymentReportRightTableTab ${receptionBasketStore.selectedRightTableTab === 'trend_coordinator' && 'selectedTab'}`} onClick={e => HandleSelectedTableTab(e, 'trend_coordinator', 1, '.paymentReportRightTableTab')}>מנחים</div>
                            <div className={`paymentReportRightTableTab ${receptionBasketStore.selectedRightTableTab === 'student' && 'selectedTab'}`} onClick={e => HandleSelectedTableTab(e, 'student', 1, '.paymentReportRightTableTab')}>תלמידים</div>
                            <div className={`paymentReportRightTableTab ${receptionBasketStore.selectedRightTableTab === 'donator' && 'selectedTab'}`} onClick={e => HandleSelectedTableTab(e, 'donator', 1, '.paymentReportRightTableTab')}>תורמים</div>
                        </div>
                ...
                <div style={{ height: receptionBasketStore.leftTableReceptionBasket.length < 10 && 'fit-content', marginLeft: '4em' }}>
                    ...
                    <Table header={['מזהה', 'שם מלא', 'סכום', 'צורת תשלום', 'עבור חודש', 'תאריך לשידור', 'סמן להדפסה']}
                        ...
                        <div className='paymentReportTableTabsPosition' style={{ right: '100%' }}>
                            <div className='paymentReportLeftTableTab selectedTab' onClick={e => HandleSelectedTableTab(e, 'donations', 0, '.paymentReportLeftTableTab')}>טיוטות תקבול</div>
                        </div>
                        {!receptionBasketStore.allReceptionBasket && <div className='paymentReportTableSpin' ><Spin size={50} color='rgba(0 0 0 / 0.7)' /></div>}
                    </Table>
                </div>
...
export default inject('rootStore')(observer(ReceptionBasket));